...
class PurchaseOrderORM(Base):
    ...
    internal_id: Mapped[str] = mapped_column(String(36), primary_key=True); po_number: Mapped[str] = mapped_column(String(128), unique=True, nullable=False); customer_id: Mapped[str] = mapped_column(ForeignKey("customers.internal_id"), nullable=False); po_date: Mapped[date] = mapped_column(Date, nullable=False); requested_delivery_date: Mapped[date|None] = mapped_column(Date); status: Mapped[str] = mapped_column(String(32), nullable=False); notes: Mapped[str|None] = mapped_column(Text); created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False); updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False); created_by: Mapped[str] = mapped_column(String(128), nullable=False); updated_by: Mapped[str] = mapped_column(String(128), nullable=False)
