...
Design system: canonical dark industrial tokens in `apps/design_tokens.py`; Open Design 0.19.0 installed and startup smoke passed. Official Codex MCP install is blocked by `CODEX_INSTALL_FAILED: spawn EPERM`; no MCP entry/read test exists.
