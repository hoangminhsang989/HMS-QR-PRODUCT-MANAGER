...
Design system: canonical dark industrial tokens in `apps/design_tokens.py`; official Open Design 0.19.0 installer download verified, installation pending action-time user confirmation, MCP not configured.
